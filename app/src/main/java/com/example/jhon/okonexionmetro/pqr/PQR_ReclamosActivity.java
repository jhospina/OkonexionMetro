...
public class PQR_ReclamosActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        App.establecerBarraAccion(this, App.txt_menuBtn_4+" - "+App.txt_pqr_reclamos);
    ...
    public void apariencia(){
        ...
        btn_crear.setBackground(fondoBtn);btn_crear.setText(App.txt_btn_crear_reclamo);
        ...
        btn_crear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ArrayList views=pqr.cargarFormularioCreacion(R.id.lay_cont_form_crear_pqr, App.txt_editText_descripcion_reclamo);
                ...
                btn_enviar.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        {
                            Mensaje.alerta(PQR_ReclamosActivity.this, App.mensaje_titulo_sin_conexion, App.mensaje_descripcion_sin_conexion, null);
                            return;
                        }
